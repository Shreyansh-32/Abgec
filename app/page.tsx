        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-xl text-gray-700 mb-8 max-w-3xl mx-auto">
              Connecting generations of engineers since 1964. Join our community
              of accomplished professionals and stay connected with your alma
              mater.
            </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Established in 1964, Government Engineering College Bilaspur has
              been a cornerstone of technical education in Chhattisgarh,
              producing skilled engineers who contribute to industry and society
              globally.
            </p>
          </div>
            ...
            <div>
              <div className="mb-8">
                ...
                <p className="text-gray-700 leading-relaxed">
                  To be a global leader by imparting quality technical education
                  and innovative research for the betterment of the industry and
                  society.
                </p>
              </div>
              ...
              <div className="mb-8">
                ...
                <ul className="text-gray-700 space-y-2">
                  <li>
                    • Developing technical competencies to enhance employability
                    and entrepreneurship
                  </li>
                  <li>
                    • Promoting research and consultancy activities to meet the
                    need of industries
                  </li>
                  <li>
                    • Inculcating ethical values and leadership qualities for
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center p-6">
              ...
              <p className="text-gray-600">
                Connect with fellow graduates and build professional networks
            ...
            <div className="text-center p-6">
              ...
              <p className="text-gray-600">
                Stay updated on alumni events, annual reunions, and college
                celebrations.
              </p>
            </div>
            ...
            <div className="text-center p-6">
              ...
              <p className="text-gray-600">
                Access career resources, mentorship programs, and job
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white rounded-lg shadow-sm overflow-hidden">
              <div className="p-6">
                ...
                <p className="text-gray-600 mb-4">
                  Join us for our annual alumni gathering to reconnect with
                  classmates and celebrate our achievements.
                </p>
                <a
                  href="#"
            ...
            <div className="bg-white rounded-lg shadow-sm overflow-hidden">
              <div className="p-6">
                ...
                <p className="text-gray-600 mb-4">
                  Alumni-led mentorship program connecting current students with
            ...
            <div className="bg-white rounded-lg shadow-sm overflow-hidden">
              <div className="p-6">
                ...
                <p className="text-gray-600 mb-4">
                  Celebrating 60+ years of excellence in technical education and
                  alumni achievements.
                </p>
                <a
                  href="#"
      ...
      <section id="contact" className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600">
              Connect with the Alumni Office for any queries or support
            </p>
          </div>
              ...
              <div className="mt-8">
                ...
                <div className="flex space-x-4">
                  ...
                  >
                    ...
                    <div className="h-8 w-8 bg-blue-600 rounded flex justify-center items-center">
                      <Facebook />
                    </div>
                  </a>
                  <a
                  ...
                  >
                    ...
                    <div className="h-8 w-8 bg-blue-700 rounded flex justify-center items-center">
                      <Linkedin />
                    </div>
                  </a>
                  <a
                  ...
                  >
                    ...
                    <div className="h-8 w-8 bg-blue-400 rounded flex justify-center items-center">
                      <Twitter />
                    </div>
                  </a>
                </div>
            ...
            <div className="bg-gray-50 p-8 rounded-lg">
              ...
              <div className="space-y-4">
                ...
                <button
                  onClick={() =>
                    alert(
                      "Message functionality would be implemented with backend integration"
                    )
                  }
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div className="col-span-1 md:col-span-2">
              ...
              <p className="text-gray-400 text-sm">
                Affiliated with Chhattisgarh Swami Vivekanand Technical
          ...
          <div className="border-t border-gray-800 mt-8 pt-8 text-center">
            <p className="text-gray-400">
              © 2025 Government Engineering College Bilaspur Alumni Association.
              All rights reserved.
            </p>
          </div>
        </div>
